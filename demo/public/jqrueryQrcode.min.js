/* jQuery.qrcode 0.11.0 - http://larsjung.de/jquery-qrcode/ - uses //github.com/kazuhikoarase/qrcode-generator (MIT) */ ! function() {
    "use strict";

    function r(r, t, e, n) {
        function o(r, t) { return r -= n, t -= n, 0 > r || r >= a || 0 > t || t >= a ? !1 : i.isDark(r, t) }
        var i = y(e, t);
    ...
    function t(t, e, n, o, i) { n = Math.max(1, n || 1), o = Math.min(40, o || 40); for (var a = n; o >= a; a += 1) try { return new r(t, e, a, i) } catch (u) {} }
    ...
    function o(r, t, o) {
        d(o.background).is("img") ? t.drawImage(o.background, 0, 0, o.size, o.size) : o.background && (t.fillStyle = o.background, t.fillRect(o.left, o.top, o.size, o.size));
        var i = o.mode;
    ...
    function g(r) { var t = d("<canvas/>").attr("width", r.size).attr("height", r.size); return c(t, r) }

    function s(r) { return d("<img/>").attr("src", g(r)[0].toDataURL("image/png")) }
    ...
    function v(r) { return w && "canvas" === r.render ? g(r) : w && "image" === r.render ? s(r) : h(r) }
    var d = jQuery,
        w = function() { var r = document.createElement("canvas"); return !(!r.getContext || !r.getContext("2d")) }(),
    ...
    d.fn.qrcode = function(r) { var t = d.extend({}, T, r); return this.each(function() { "canvas" === this.nodeName.toLowerCase() ? c(this, t) : d(this).append(v(t)) }) };
    var y = function() {
        function r(t, e) {
            ...
            return o.get = function(r) { return n[r] }, o.getLength = function() { return n.length }, o.multiply = function(t) {
                ...
                return r(e, 0)
            }, o.mod = function(t) { if (o.getLength() - t.getLength() < 0) return o; for (var e = a.glog(o.get(0)) - a.glog(t.get(0)), n = new Array(o.getLength()), i = 0; i < o.getLength(); i += 1) n[i] = o.get(i); for (var i = 0; i < t.getLength(); i += 1) n[i] ^= a.gexp(a.glog(t.get(i)) + e); return r(n, 0).mod(t) }, o
        }
        var t = function(t, e) {
            var o = 236,
                a = 17,
                ...
                w = new Array,
                m = {},
                T = function(r, t) { h = 4 * c + 17, s = function(r) { for (var t = new Array(r), e = 0; r > e; e += 1) { t[e] = new Array(r); for (var n = 0; r > n; n += 1) t[e][n] = null } return t }(h), y(0, 0), y(h - 7, 0), y(0, h - 7), E(), B(), A(r, t), c >= 7 && k(r), null == d && (d = C(c, g, w)), M(d, t) },
                y = function(r, t) {
                    for (var e = -1; 7 >= e; e += 1)
                        if (!(-1 >= r + e || r + e >= h))
            ...
            return m.addData = function(r) {
                var t = l(r);
                w.push(t), d = null
            }, m.isDark = function(r, t) { if (0 > r || r >= h || 0 > t || t >= h) throw new Error(r + "," + t); return s[r][t] }, m.getModuleCount = function() { return h }, m.make = function() { T(!1, p()) }, m.createTableTag = function(r, t) {
        ...
        t.stringToBytes = function(r) {
            ...
            var e = function() {
                    for (var e = s(r), n = function() { var r = e.read(); if (-1 == r) throw new Error; return r }, o = 0, i = {};;) {
                        var a = e.read();
                        if (-1 == a) break;
                        var u = n(),
                            f = n(),
        ...
        var e = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
            ...
            i = function() {
                var t = [
                    ...
                    u = 21522,
                    f = {},
                    l = function(r) { for (var t = 0; 0 != r;) t += 1, r >>>= 1; return t };
                return f.getBCHTypeInfo = function(r) { for (var t = r << 10; l(t) - l(n) >= 0;) t ^= n << l(t) - l(n); return (r << 10 | t) ^ u }, f.getBCHTypeNumber = function(r) { for (var t = r << 12; l(t) - l(i) >= 0;) t ^= i << l(t) - l(i); return r << 12 | t }, f.getPatternPosition = function(r) { return t[r - 1] }, f.getMaskFunction = function(r) {
                    switch (r) {
                        case o.PATTERN000:
                            return function(r, t) { return (r + t) % 2 == 0 };
                        case o.PATTERN001:
                            return function(r) { return r % 2 == 0 };
                        case o.PATTERN010:
            ...
            f = function() {
                var r = new Array,
                    t = 0,
                    e = {};
                return e.getBuffer = function() { return r }, e.get = function(t) { var e = Math.floor(t / 8); return 1 == (r[e] >>> 7 - t % 8 & 1) }, e.put = function(r, t) { for (var n = 0; t > n; n += 1) e.putBit(1 == (r >>> t - n - 1 & 1)) }, e.getLengthInBits = function() { return t }, e.putBit = function(e) {
            ...
            l = function(r) {
                var n = e.MODE_8BIT_BYTE,
                    o = t.stringToBytes(r),
                    i = {};
                return i.getMode = function() { return n }, i.getLength = function() { return o.length }, i.write = function(r) { for (var t = 0; t < o.length; t += 1) r.put(o[t], 8) }, i
            },
            c = function() {
                var r = new Array,
                    t = {};
